...
Both Account screens keep a collapsible **Alerts & permissions** card (rows for booking alerts and location, live states, one-tap **Turn on** / **How to allow**, and a **Support report** for the technical detail). Configuration details and check names stay out of the everyday view. A blocked permission is explained with three short steps for the browser actually in use, never a wall of text.
